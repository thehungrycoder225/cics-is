    ...
    datasets: [
      {
        ...
        data: [1279, 1211, 1067, 1073, 1093, 1168, 1346, 1535],
        backgroundColor: 'rgba(26, 166, 5, 1)',
        borderColor: 'rgba(26, 166, 5, 0)',
        borderWidth: 1,
      },
      {
        label: 'Information Systems',
        data: [490, 351, 232, 226, 246, 270, 275, 350],
        backgroundColor: 'rgba(251, 170, 48,1)',
        borderColor: 'rgba(251, 170, 48, 0)',
        borderWidth: 1,
      },
      {
        label: 'Total',
        data: [1769, 1562, 1299, 1299, 1339, 1438, 1621, 1885],
        type: 'line',
        backgroundColor: 'rgba(91, 0, 0, 1)',
        borderColor: 'rgba(91, 0, 0, 1)',
        borderWidth: 2,
      },
    ],
  },
